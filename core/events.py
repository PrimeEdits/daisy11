...
INTRO = r"""
 _______  _        _______             ______  _________ _______  _______  _______  _______  ______     ______   _______ _________
(  ____ )( (    /|(  ___  )           (  __  \ \__   __/(  ____ \(  ____ \(  ___  )(  ____ )(  __  \   (  ___ \ (  ___  )\__   __/
| (    )||  \  ( || (   ) |           | (  \  )   ) (   | (    \/| (    \/| (   ) || (    )|| (  \  )  | (   ) )| (   ) |   ) (   
| (____)||   \ | || |   | |   _____   | |   ) |   | |   | (_____ | |      | |   | || (____)|| |   ) |  | (__/ / | |   | |   | |   
|  _____)| (\ \) || |   | |  (_____)  | |   | |   | |   (_____  )| |      | |   | ||     __)| |   | |  |  __ (  | |   | |   | |   
| (      | | \   || |   | |           | |   ) |   | |         ) || |      | |   | || (\ (   | |   ) |  | (  \ \ | |   | |   | |   
| )      | )  \  || (___) |           | (__/  )___) (___/\____) || (____/\| (___) || ) \ \__| (__/  )  | )___) )| (___) |   | |   
|/       |/    )_)(_______)           (______/ \_______/\_______)(_______/(_______)|/   \__/(______/   |/ \___/ (_______)   )_(
"""
