...
class Core(commands.Cog, CoreLogic):
    ...
    async def info(self, ctx: commands.Context):
        """Shows info about PnO"""
        author_repo = "https://github.com/PrimeEdits"
        org_repo = "https://media.tenor.com/images/6326dfe238979d31e0f90b7faafa5281/tenor.gif"
        red_repo = org_repo + "/PnO-DiscordBot"
        red_pypi = "https://pypi.org/project/PnO-DiscordBot"
        red_pypi_json = "https://pypi.org/pypi/PnO-DiscordBot/json"
        support_server_url = "https://discord.gg/8crjRNK"
        dpy_repo = ""
        ...
        about = _(
            "This bot is an instance of [PnO, an open source Discord bot]({}) "
            "created by [Prime]({}) and [improved by my dicc]({}).\n\n"
            "PnO is backed by a passionate community who contributes and "
        ...
        embed.add_field(name=_("PnO version"), value=red_version)
        ...
        embed.add_field(name=_("About PnO"), value=about, inline=False)
    ...
    async def setdescription(self, ctx: commands.Context, *, description: str = ""):
        ...
        The default is "PnO V3"
        """
        if not description:
            await ctx.bot._config.description.clear()
            ctx.bot.description = "PnO V3"
    ...
    async def locale(self, ctx: commands.Context, language_code: str):
        ...
        Go to PnO's Crowdin page to see locales that are available with translations:
        https://translate.discord.PnO
    ...
    async def debuginfo(self, ctx: commands.Context):
        ...
        if await ctx.embed_requested():
            ...
            e.title = "Debug Info for PnO"
            e.add_field(name="PnO version", value=redver, inline=True)
...
async def license_info_command(ctx):
    """
    Get info about PnO's licenses
    """

    message = (
        "This bot is an instance of PnO-DiscordBot (hereafter referred to as Daisy)\n"
